...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        mailFiled.background = [UIImage imageNamed:@"loginname"];
        ...
        //*****************************密码*************************************
        field2=[[UITextField alloc]initWithFrame:CGRectMake(51, 78, 267, 40.5)];
        ...
        mailFiled1.background = [UIImage imageNamed:@"loginpassword"];
        ...
        button1.frame=CGRectMake(173, 0, 110, 29);//整个View的y=78；
        button1.backgroundColor=[UIColor clearColor];
        [button1 setBackgroundImage:[UIImage imageNamed:@"denglu"] forState:UIControlStateNormal];
        [button1 addTarget:self action:@selector(gotoSina) forControlEvents:UIControlEventTouchUpInside];
        [self addSubview:button1];
        //*****************************账号转换按钮 end*************************************
        //*****************************新浪图标*************************************
        button2=[UIButton buttonWithType:UIButtonTypeCustom];
        button2.frame=CGRectMake(22, 128, 235, 36);
        [button2 setBackgroundImage:[UIImage imageNamed:@"loginsina"] forState:UIControlStateNormal];
        [button2 setBackgroundImage:[UIImage imageNamed:@"loginsinaing"] forState:UIControlStateSelected];
        [button2 addTarget:self action:@selector(gotoSina) forControlEvents:UIControlEventTouchUpInside];
